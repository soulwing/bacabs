(function() {
  ...
  var NotificationService = function(WebSocketService, DeploymentService, $q, $timeout) {
    var self = this;
  ...
  angular.module("bacabs.services.notificationService",
          ['bacabs.services.webSocketService', 'bacabs.services.deploymentService'])
