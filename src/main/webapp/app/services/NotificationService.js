(function() {
  ...
  var service = angular.module("bacabs.services.notificationService", ['bacabs.services.webSocketService']);
  
  service.factory('NotificationService', function(WebSocketService, $q, $timeout) {
    return new (function() {
      var self = this;
