...
public interface JiraIssue {
   ...
   * @return The current status of the issue
   */
  String getStatus();
  ...
  /**
   * Get the status of the acceptance task of the issue
   * @return The status of the acceptance test
   */
  String getAcceptanceTaskStatus();
}
