(function() {
  ...
  function NotificationService(WebSocketService, DeploymentService, $q, $timeout) {
    _init();
    return {
    ...
    function _init() {
      WebSocketService.registerListener("NewDeploymentEvent", _onNewDeploymentEvent);
      WebSocketService.registerListener("RemovedDeploymentEvent", _onRemovedDeploymentEvent);
      WebSocketService.registerListener("UpdatedDeploymentEvent", _onUpdatedDeploymentEvent);
    }
